    ...
    <>
        ...
        {!isMobileSize && 
          <div className="nav-2">
            <nav className="nav-container">
              <NavLink id="btn-1" className={`nav-btn red-top ${isScrolled && "scrolled"}`} to="/">About Me</NavLink>
              <NavLink id="btn-1" className={`nav-btn yellow-top ${isScrolled && "scrolled"}`} to="/portfolio">Portfolio</NavLink>
              <NavLink id="btn-1" className={`nav-btn green-top ${isScrolled && "scrolled"}`} to="/blog">Blog</NavLink>
              <NavLink id="btn-1" className={`nav-btn blue-top ${isScrolled && "scrolled"}`} to="/resume">Resumé</NavLink>
            </nav>
      ...
      {isMobileSize && 
        <div className={`nav-2 ${isMenuVisible && "visible"}`}>
          <nav className="nav-container">
            <NavLink id="btn-1" className="nav-btn red-rgt" to="/" onClick={closeMenu}>About Me</NavLink>
            <NavLink id="btn-1" className="nav-btn yellow-rgt" to="/portfolio" onClick={closeMenu}>Portfolio</NavLink>
            <NavLink id="btn-1" className="nav-btn green-rgt" to="/blog" onClick={closeMenu}>Blog</NavLink>
            <NavLink id="btn-1" className="nav-btn blue-rgt" to="/resume" onClick={closeMenu}>Resumé</NavLink>
          </nav>
